              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className={`p-2 rounded-lg opacity-0 group-hover:opacity-100 transition-all ${isAdded
          ...
          {watchlist.length === 0 ? (
            ...
            watchlist.map(asset => {
              ...
              return (
                <div
                  key={asset.symbol}
                  className={`flex justify-between items-center p-3 rounded-xl transition-all cursor-pointer group relative overflow-hidden ${isSelected
