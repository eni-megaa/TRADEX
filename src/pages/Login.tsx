      ...
      <div className="flex-grow flex items-center justify-center px-4 py-4">
        <div className="max-w-[340px] w-full">
          <div className="text-center mb-4">
            <h2 className="text-2xl font-bold mb-1">Log In Account</h2>
          ...
          <form onSubmit={handleLogin} className="space-y-3">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link to="/reset-password" className="text-sm font-medium text-gray-400 hover:text-white transition-colors">Forgot password?</Link>
              </div>
          ...
          <p className="mt-4 text-center text-sm text-gray-400">
            ...
            <Link to="/register" className="font-semibold text-white hover:text-accent transition-colors">
              Sign up
            </Link>
          </p>
        </div>
